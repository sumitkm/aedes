...
declare namespace aedes {
    ...
    export type AuthorizeSubscribeCallback = (client: Client, subscription: ISubscription, done: (err: Error | null, subscription?: ISubscription) => void) => void
    ...
    export interface Aedes extends EventEmitter {
      ...
      on (event: 'ping' | 'publish' | 'ack', cb: (packet: IPublishPacket & { id: string }, client: Client) => void): this
